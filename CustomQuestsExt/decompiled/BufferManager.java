...
import l2.commons.lang.StringUtils;
import l2.gameserver.Config;
import l2.gameserver.data.xml.holder.BufferManagerHolder;
import l2.gameserver.database.DatabaseFactory;
import l2.gameserver.model.Skill;
import l2.gameserver.model.actor.Creature;
import l2.gameserver.model.actor.instance.NpcInstance;
...
/**
 * Loads and stores available {@link BuffSkill}s for the integrated scheme buffer.
...
public final class BufferManager extends AbstractFileParser<BufferManagerHolder> {
    ...
    protected void readData(Element rootElement) throws Exception {
        ...
        while (categoryIterator.hasNext()) {
            ...
            while (buffIterator.hasNext()) {
                ...
                _availableBuffs.put(skillId, new BuffSkill(skillId, skillLevel, price, category, desc));
            }
        }
        
        info("Loaded " + _availableBuffs.size() + " available buffs.");
     ...
     * @return The {@link List} holding skill ids for the given scheme name and Player, or empty list if scheme or Player isn't registered.
     */
