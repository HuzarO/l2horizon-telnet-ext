...
implements JdbcEntity {
    private static final Logger II1I1I11 = LoggerFactory.getLogger(Residence.class);
    ...
    private int III11I111;
    private int l1l1lIII1l;
    private int I1l1I11I1l1;
    ...
    protected void loadFunctions() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                this.lllllllI(residenceFunction);
            }
        }
        catch (Exception exception) {
            try {
                II1I1I11.warn("Residence: loadFunctions(): " + exception, (Throwable)exception);
            }
    ...
    public boolean updateFunctions(int n, int n2) {
        ...
        try {
            ...
            II1I1I11.warn("Exception: SiegeUnit.updateFunctions(int type, int lvl, int lease, long rate, long time, boolean addNew): " + exception);
        }
        finally {
            DbUtils.closeQuietly(connection, preparedStatement);
        }
    ...
    public void removeFunction(int n) {
        ...
        try {
            ...
            try {
                II1I1I11.warn("Exception: removeFunctions(int type): " + exception);
            }
            catch (Throwable throwable) {
                DbUtils.closeQuietly(connection, preparedStatement);
                throw throwable;
    ...
    private void lllllllI(ResidenceFunction residenceFunction) {
    ...
    extends RunnableImpl {
        ...
        public void runImpl() throws Exception {
            Residence.this.lllllllI(this._function);
        }
    }
