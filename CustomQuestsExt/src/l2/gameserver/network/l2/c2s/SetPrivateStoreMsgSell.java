...
/**
 * Classpath override of the server.jar packet (0x97, the Message button of the private
 * store sell window). Stock logic recreated from the decompiled original, plus the Buff
 * Store: with a buff store open or a /buff setup pending the text becomes the buff
 * store bubble title instead of the item store name.
 */
