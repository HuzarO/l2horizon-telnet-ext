...
/**
 * Sandstorm (32350) of the Hellbound desert. Ported from the High Five
 * ai.hellbound.Sandstorm: runs around its spawn point, stuns (5435) and
 * knocks back (5494) anyone within 200 units, even in silent move, and never
 * fights.
 */
public class Sandstorm extends DefaultAI
{
	...
	protected boolean thinkActive()
	{
		...
		if(SKILL1 != null && SKILL2 != null && lastThrow + 5000 < System.currentTimeMillis())
