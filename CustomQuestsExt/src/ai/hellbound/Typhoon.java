...
/**
 * Typhoon (25539), the raid boss patrolling the Hellbound shore. Ported from
 * the High Five ai.hellbound.Typhoon: walks its route from point to point and
 * attacks whoever it meets on the way.
 */
public class Typhoon extends Fighter
{
	...
	protected boolean checkAggression(Creature target)
	{
		...
		// moving from point to point: step back so the route resumes after the fight
