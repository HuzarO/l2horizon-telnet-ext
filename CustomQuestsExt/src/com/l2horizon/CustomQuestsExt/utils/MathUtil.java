...
public class MathUtil {
	...
	public static final int[][] MATRICE_3X3_LINES = { { 1, 2, 3 }, // line 1
			{ 4, 5, 6 }, // line 2
			{ 7, 8, 9 }, // line 3
			{ 1, 4, 7 }, // column 1
			{ 2, 5, 8 }, // column 2
	 ...
	 * @return The number of pages, based on the number of elements and the number
	 *         of elements we want per page.
	 */
	 ...
	 * <br>
	 * The angle is calculated based on the coordinates of the two points, relative
	 ...
	 * <br>
	 * The heading is typically represented as an integer value in a range where 0
	 * corresponds to 0 degrees, and 65535 corresponds to just under 360 degrees.
	 * This method converts that heading to a standard degree value.
	 * 
	 * @param clientHeading : The heading value to be converted, typically in the
	 *                      range [0, 65535].
	...
	/**
	 * Calculate a new location based on a starting point, a heading, and a
	 * distance.<br>
	 * <br>
	 * The method converts the heading to degrees and calculates the new position
	 * after moving a specified distance in the direction of the heading from the
	 * given coordinates.
	 * 
	 * @param x        : The X coordinate of the starting point.
	 * @param y        : The Y coordinate of the starting point.
	 * @param heading  : The heading in game-specific units (not degrees).
	 * @param distance : The distance to move from the starting point in the
	...
	/**
	 * Calculate a new location based on a starting point, an angle in degrees, and
	 * a distance.<br>
	 * <br>
	 * The method calculates the new position after moving a specified distance in
	 * the direction of the given angle from the provided coordinates.
	 * 
	 * @param x        : The X coordinate of the starting point.
	 * @param y        : The Y coordinate of the starting point.
	 ...
	 * <br>
	 * The heading is computed as the angle in degrees between the line formed by
	 * the two points and the positive X-axis, adjusted to fall within the range [0,
	 * 360) degrees. This angle is then converted into a game-specific heading,
	 * where 360 degrees corresponds to 65536 units.
	 * 
	 * @param obj1X : The X coordinate of the first point.
	 * @param obj1Y : The Y coordinate of the first point.
	 * @param obj2X : The X coordinate of the second point.
	 * @param obj2Y : The Y coordinate of the second point.
	 * @return The calculated heading as an integer, where 0 represents 0 degrees,
	 *         and 65535 represents just under 360 degrees
	 */
	 ...
	 * @return The rounded value to specified number of digits after the decimal
	 *         point. Based on PHP round().
	 */
