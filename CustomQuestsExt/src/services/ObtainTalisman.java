 ...
 * filtered against ItemHolder at runtime because this pack carries only part of
 * the H5 talisman items (more join the pool automatically once added).
 */
public class ObtainTalisman extends Functions
{
	...
	public void Obtain()
	{
		...
		List<Integer> talismans = new ArrayList<Integer>();
