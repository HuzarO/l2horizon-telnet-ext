...
/**
 * Four Goblets (620), the scripts.jar quest with two changes so the Shining Bow is
 * obtainable like the Draconic Bow: the sealed box reward tables that hold the
 * Draconic Bow Shaft (7579, 101 of 1000) also hold the Shining Bow Shaft (6692) at
 * the same weight (the roll is 1101 wide now, so every other part is a little less
 * likely), and the Ghost of Wigoth exchanges 1000 Broken Relic Parts for Recipe:
 * Shining Bow (60%) (reply_shining_bow, dialog wigoth_ghost_b_q0620_16.htm) as it
 * does for the Draconic Bow's recipe.
 *
 * This class shadows quests._620_FourGoblets of scripts.jar (the extension jar
 * precedes it on the classpath); the rest is the decompiled original, with the two
 * temporaries the decompiler left undeclared declared.
 */
public class _620_FourGoblets
extends Quest
implements ScriptFile {
    private static final int Hb = 31453;
    private static final int Hc = 31919;
    private static final int Hd = 31920;
    private static final int He = 31452;
    private static final int Hf = 31454;
    private static final int Hg = 31921;
    private static final int Hh = 31922;
    private static final int Hi = 31923;
    private static final int Hj = 31924;
    private static final int Hk = 55;
    private static final int Hl = 25339;
    private static final int Hm = 25342;
    private static final int Hn = 25346;
    private static final int Ho = 25349;
    private static final HashMap<Integer, Integer> \u0406I\uff49I\u0406\uff49\uff49\u0406I = new HashMap(61);
    private static final HashMap<Integer, Integer> \u04c01\uff4c\uff4cIlI1\uff49 = new HashMap(10);
    private static final HashMap<Integer, Integer> \uff49lI\uff4cIl\uff4cll = new HashMap(8);
    ...
    public _620_FourGoblets() {
        ...
        this.addKillId(\u0406I\uff49I\u0406\uff49\uff49\u0406I.keySet());
        this.addKillId(\u04c01\uff4c\uff4cIlI1\uff49.keySet());
        this.addKillId(\uff49lI\uff4cIl\uff4cll.keySet());
    ...
    public String onEvent(String string, QuestState questState, NpcInstance npcInstance) {
        ...
        if (n2 == 31919) {
            if (string.equalsIgnoreCase("reply_1")) {
                if (questState.isStarted() && questState.getQuestItemsCount(7255) >= 1L) {
                    int var10_20 = 0; // the decompiler lost this declaration
                    int n3 = 0;
                        ...
                        if (Rnd.get((int)100) < 50) {
                            ...
                            if (n4 == 0) {
                                ...
                                if (Rnd.get((int)1000) < 54) {
                                    ...
                                    } else if (var10_20 < 600) {
                                        questState.giveItems(6692, 1L); // l2horizon: Shining Bow Shaft, the Draconic Bow Shaft's 101 of now 1101
                                    } else if (var10_20 < 702) {
                                        questState.giveItems(6693, 1L);
                                    } else if (var10_20 < 804) {
                                        questState.giveItems(6694, 1L);
                                    } else if (var10_20 < 902) {
                                        questState.giveItems(6695, 1L);
                                    } else if (var10_20 < 1003) {
        ...
        if (n2 == 31454) {
            if (string.equalsIgnoreCase("reply_1")) {
                ...
                int var11_26 = 0; // the decompiler lost this declaration
                int n5 = 0;
                        ...
                        if (n6 == 0) {
                            ...
                            if (Rnd.get((int)1000) < 54) {
                                ...
                                if (var11_26 < 100) {
                                    ...
                                    questState.giveItems(7579, 1L);
                                } else if (var11_26 < 600) {
                                    questState.giveItems(6692, 1L); // l2horizon: Shining Bow Shaft, the Draconic Bow Shaft's 101 of now 1101
                                } else if (var11_26 < 702) {
                                    questState.giveItems(6693, 1L);
                                } else if (var11_26 < 804) {
                                    questState.giveItems(6694, 1L);
                                } else if (var11_26 < 902) {
                                    questState.giveItems(6695, 1L);
                                } else if (var11_26 < 1003) {
                                    questState.giveItems(6696, 1L);
                                } else {
                                    questState.giveItems(6697, 1L);
                                }
            ...
            // l2horizon: Recipe: Shining Bow (60%) for 1000 Broken Relic Parts, like the Draconic Bow recipe
            if (string.equalsIgnoreCase("reply_shining_bow")) {
                if (!questState.isStarted()) return string2;
                if (n != 2) {
                    if (n != 3) return string2;
                }
                if (questState.getQuestItemsCount(7254) < 1000L) return string2;
                questState.giveItems(6889, 1L);
                questState.takeItems(7254, 1000L);
                return "wigoth_ghost_b_q0620_21.htm";
            }
            if (string.equalsIgnoreCase("reply_8")) {
    ...
    public String onKill(NpcInstance npcInstance, QuestState questState) {
        ...
        } else if (\u0406I\uff49I\u0406\uff49\uff49\u0406I.containsKey(n)) {
            QuestState questState4 = this.getRandomPartyMemberWithQuest(player, -1);
            if (questState4 != null && questState4.rollAndGive(7255, Rnd.chance((int)\u0406I\uff49I\u0406\uff49\uff49\u0406I.get(n)) ? 2 : 1, 100.0)) {
                questState4.playSound("ItemSound.quest_itemget");
            }
        } else if (\u04c01\uff4c\uff4cIlI1\uff49.containsKey(n)) {
            QuestState questState5 = this.getRandomPartyMemberWithQuest(player, -1);
            if (questState5 != null && questState5.rollAndGive(7255, 1, (double)\u04c01\uff4c\uff4cIlI1\uff49.get(n).intValue())) {
                questState5.playSound("ItemSound.quest_itemget");
            }
        } else if (\uff49lI\uff4cIl\uff4cll.containsKey(n) && (questState2 = this.getRandomPartyMemberWithQuest(player, -1)) != null && questState2.rollAndGive(7255, Rnd.chance((int)\uff49lI\uff4cIl\uff4cll.get(n)) ? 5 : 4, 100.0)) {
    ...
    static {
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18120, 51);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18122, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18121, 44);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18123, 51);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18125, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18124, 44);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18126, 51);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18128, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18127, 44);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18129, 51);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18131, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18130, 44);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18132, 54);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18133, 42);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18134, 7);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18135, 42);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18136, 42);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18138, 41);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18139, 39);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18137, 6);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18140, 41);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18166, 8);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18167, 7);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18168, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18169, 6);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18171, 11);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18170, 7);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18172, 6);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18173, 17);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18175, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18174, 45);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18176, 17);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18178, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18177, 45);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18179, 17);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18181, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18180, 45);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18182, 17);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18184, 10);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18183, 45);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18195, 8);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18185, 46);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18186, 47);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18187, 42);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18188, 7);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18189, 42);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18190, 42);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18192, 41);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18193, 39);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18191, 6);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18194, 41);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18220, 47);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18221, 51);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18222, 43);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18223, 7);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18224, 44);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18225, 43);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18227, 82);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18228, 36);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18226, 6);
        \u0406I\uff49I\u0406\uff49\uff49\u0406I.put(18229, 41);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18141, 90);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18142, 90);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18143, 90);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18144, 90);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18149, 75);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18148, 85);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18146, 78);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18147, 73);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18145, 76);
        \u04c01\uff4c\uff4cIlI1\uff49.put(18230, 58);
        \uff49lI\uff4cIl\uff4cll.put(18212, 50);
        \uff49lI\uff4cIl\uff4cll.put(18213, 50);
        \uff49lI\uff4cIl\uff4cll.put(18214, 50);
        \uff49lI\uff4cIl\uff4cll.put(18215, 50);
        \uff49lI\uff4cIl\uff4cll.put(18216, 50);
        \uff49lI\uff4cIl\uff4cll.put(18217, 50);
        \uff49lI\uff4cIl\uff4cll.put(18218, 50);
        \uff49lI\uff4cIl\uff4cll.put(18219, 50);
    }
}
